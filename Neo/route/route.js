...
module.exports = function(app) {
  ...
  app.get(
    prefix + "/blockhashbyheight",
    neoNodeController.getBlockHashByHeight
  );
  ...
  app.post(
    prefixClient + "/getaccountstate",
    neoClientController.getaccountstate
  );
  app.post(
    prefixClient + "/getapplicationlog",
    neoClientController.getapplicationlog
  ); // Need to enable logging
  ...
  app.post(
    prefixClient + "/getbestblockhash",
    neoClientController.getbestblockhash
  );
  ...
  app.post(
    prefixClient + "/getblocksysfee",
    neoClientController.getblocksysfee
  );
  app.post(
    prefixClient + "/getconnectioncount",
    neoClientController.getconnectioncount
  );
  app.post(
    prefixClient + "/getcontractstate",
    neoClientController.getcontractstate
  );
  ...
  app.post(
    prefixClient + "/getrawtransaction",
    neoClientController.getrawtransaction
  );
  ...
  app.post(
    prefixClient + "/invokefunction",
    neoClientController.invokefunction
  );
  ...
  app.post(
    prefixClient + "/validateaddress",
    neoClientController.validateaddress
