...
var client = rpc.Client.$create(config.BCH_RPC_PORT, config.BCH_RPC_HOST, config.BCH_RPC_USER, config.BCH_RPC_PASS);

export class BchRouter {
...
const bchRoutes = new BchRouter();
bchRoutes.routes();

export default bchRoutes.router;