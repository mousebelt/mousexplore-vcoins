...
var client = rpc.Client.$create(config.QTUM_RPC_PORT, config.QTUM_RPC_HOST, config.QTUM_RPC_USER, config.QTUM_RPC_PASS);

export class QtumRouter {
...
const qtumRoutes = new QtumRouter();
qtumRoutes.routes();

export default qtumRoutes.router;