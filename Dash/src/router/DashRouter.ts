...
var client = rpc.Client.$create(config.DASH_RPC_PORT, config.DASH_RPC_HOST, config.DASH_RPC_USER, config.DASH_RPC_PASS);
...
const dashRoutes = new DashRouter();
dashRoutes.routes();

export default dashRoutes.router;